...
perpopRED<-read.table("perpopREDMaMi2022.txt",   sep = "\t", header=T, as.is=T)
...
infoID<-read.csv("infoGelatoMarch2020matchfam.csv",header=T, as.is=T)
#******************************************

## FST pairwise file in MASTERFILE

perpopMASTER<-read_xlsx("perpopMASTER_653pops2022.xlsx")
